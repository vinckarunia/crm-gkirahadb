...
<div class="row">
    ...
    <div class="col-lg-9 col-md-9 col-sm-9">
        ...
        <div class="card">
            <div class="card-header p-2">
                <ul class="nav nav-pills">
                    <li class="nav-item"><a class="nav-link active" id="nav-item-about" href="#about" data-toggle="tab"><?= gettext('About Me') ?></a></li>
                    <li class="nav-item"><a class="nav-link" id="nav-item-family" href="#family" data-toggle="tab"><?= gettext('Family') ?></a></li>
                    ...
                    <?php } ?>
                    <li class="nav-item"><a class="nav-link" id="nav-item-qr" href="#qr" data-toggle="tab"><?= gettext('Check-in QR') ?></a></li>
                </ul>
            </div>
            <div class="card-body">
                <div class="tab-content">
                        ...
                        <div class="row">
                            <?php if ($fam_ID != '') { ?>
                                <div class="col-12 mb-2">
                                    <i class="fa fa-people-roof"></i> <?= gettext('Family:'); ?>
                                    <span>
                            ...
                            <?php } else { ?>
                                <div class="col-12 mb-2">
                                    <i class="fa fa-people-roof"></i> <?= gettext('Family:'); ?> <span><?= gettext('(No assigned family)') ?></span>
                                </div>
                            <?php } ?>

                            <?php if (!empty($formattedMailingAddress)) { ?>
                                <div class="col-12 mb-2">
                                    <i class="fa fa-home"></i> <?= gettext('Address'); ?>: 
                                    <span>
                            ...
                            <?php if ($dBirthDate) { ?>
                                <div class="col-12 mb-2">
                                    <i class="fa fa-calendar"></i> <?= gettext('Birth Date') ?>: <?= $dBirthDate ?>
                                    <?php if (!$person->hideAge()) { ?>(<span><?= $person->getAge() ?></span>)<?php } ?>
                                </div>
                            <?php } ?>

                            <?php if (!SystemConfig::getValue('bHideFriendDate') && $per_FriendDate != '') { ?>
                                <div class="col-12 mb-2">
                                    <i class="fa fa-tasks"></i> <?= gettext('Friend Date') ?>: <span><?= FormatDate($per_FriendDate, false) ?></span>
                                </div>
                            <?php } ?>

                            <?php if ($sCellPhone) { ?>
                                <div class="col-12 mb-2">
                                    <i class="fa fa-mobile-phone"></i> <?= gettext('Mobile Phone') ?>: 
                                    <span><a href="tel:<?= $sCellPhoneUnformatted ?>"><?= $sCellPhone ?></a></span>
                                </div>
                            <?php } ?>

                            <?php if ($sHomePhone) { ?>
                                <div class="col-12 mb-2">
                                    <i class="fa fa-phone"></i> <?= gettext('Home Phone') ?>: 
                                    <span><a href="tel:<?= $sHomePhoneUnformatted ?>"><?= $sHomePhone ?></a></span>
                                </div>
                            <?php } ?>

                            <?php if ($sEmail != '') { ?>
                                <div class="col-12 mb-2">
                                    <i class="fa fa-envelope"></i> <?= gettext('Email') ?>: 
                                    <span><a href="mailto:<?= $sUnformattedEmail ?>"><?= $sEmail ?></a></span>
                                </div>
                            <?php } ?>

                            <?php if ($sWorkPhone) { ?>
                                <div class="col-12 mb-2">
                                    <i class="fa fa-phone"></i> <?= gettext('Work Phone') ?>: 
                                    <span><a href="tel:<?= $sWorkPhoneUnformatted ?>"><?= $sWorkPhone ?></a></span>
                                </div>
                            <?php } ?>

                            <?php if ($per_WorkEmail != '') { ?>
                                <div class="col-12 mb-2">
                                    <i class="fa fa-envelope"></i> <?= gettext('Work/Other Email') ?>: 
                                    <span><a href="mailto:<?= $per_WorkEmail ?>"><?= $per_WorkEmail ?></a></span>
                                </div>
                            <?php } ?>

                            <?php if (strlen($per_Facebook) > 0) { ?>
                                <div class="col-12 mb-2">
                                    <i class="fa-brands fa-facebook-official"></i> Facebook: 
                                    <span><a href="https://www.facebook.com/<?= InputUtils::filterString($per_Facebook) ?>" target="_blank"><?= $per_Facebook ?></a></span>
                                </div>
                            <?php } ?>
                            ...
                            <?php if (strlen($per_Twitter) > 0) { ?>
                                <div class="col-12 mb-2">
                                    ...
                                    <span><a href="https://www.twitter.com/<?= InputUtils::filterString($per_Twitter) ?>" target="_blank"><?= $per_Twitter ?></a></span>
                                </div>
                            <?php } ?>
                            ...
                            <?php if (strlen($per_LinkedIn) > 0) { ?>
                                <div class="col-12 mb-2">
                                    ...
                                    <span><a href="https://www.linkedin.com/in/<?= InputUtils::FiltersTring($per_LinkedIn) ?>" target="_blank"><?= $per_LinkedIn ?></a></span>
                                </div>
                            <?php } ?>
                            ...
                            while ($Row = mysqli_fetch_array($rsCustomFields)) {
                                ...
                                if ($currentData != '') {
                                    ...
                                    ?>
                                    <div class="col-12 mb-2">
                                        <i class="<?= $displayIcon ?>"></i> <?= $custom_Name ?>: 
                                        <span>
                                            <?php
                    ...
                    <div class="tab-pane" id="qr">
                        <div class="card">
                            <div class="card-header">
                                <?php $qrValue = str_pad($person->getId(), 5, "0", STR_PAD_LEFT); ?>                                
                                <div id="qrcode" class="my-3" data-qrtext="<?= htmlspecialchars($qrValue) ?>"></div>
                            </div>
                            <div class="card-body">
                                <button id="downloadQR" class="btn btn-primary btn-sm">
                                    <i class="fa fa-download"></i> <?= gettext("Download QR") ?>
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        <script src="<?= SystemURLs::getRootPath() ?>/skin/external/qrcodejs/qrcode.min.js"></script>
