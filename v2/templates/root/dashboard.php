...
<div class="row">
    <div class="card col-md-6">
        <div class="card-body">
            <h4><?= gettext("This Week's Birthdays") ?></h4>
                            ...
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                    <?php foreach ($data['people'] as $person): ?>
                                        <tr>
                                            <td>
                                                <a href="/churchcrm/PersonView.php?PersonID=<?= $person['Id'] ?>">
    ...
    <div class="card col-md-6">
        <div class="card-body">
            <h4><?= gettext("Next Week's Birthdays") ?></h4>
            <table class="table table-striped" width="100%">
            <thead>
                <tr>
                    <th><?= gettext("Date") ?></th>
 	...
 	<div class="card col-md-12">
  		<div class="card-body">
    		<h4><?= gettext("LKKJ") ?></h4>
          	<p>Untuk mengedit atau melihat LKKJ lebih lanjut, gunakan tautan <a href="https://metabase.gkirahadb.my.id/" target="_blank" style="text-decoration: none; color: primary;">berikut</a>.</p>
    		<?php
				$url = "https://metabase.gkirahadb.my.id/public/dashboard/04474c34-c1ba-4598-bd89-9b730689ec7f";
			?>
