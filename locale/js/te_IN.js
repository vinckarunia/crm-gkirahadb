// Source POEditor: locale/JSONKeys/te_IN.json
try {window.CRM.i18keys = {
    ...
    "This tool will assist you in manually backing up the ChurchCRM database.": "ChurchCRM డేటాబేస్‌ను మాన్యువల్‌గా బ్యాకప్ చేయడంలో ఈ సాధనం మీకు సహాయం చేస్తుంది.",
    "You should make a manual backup at least once a week unless you already have a regular backup procedure for your systems.": "మీరు ఇప్పటికే మీ సిస్టమ్‌ల కోసం సాధారణ బ్యాకప్ విధానాన్ని కలిగి ఉండకపోతే మీరు కనీసం వారానికి ఒకసారి మాన్యువల్ బ్యాకప్ చేయాలి",
    "After you download the backup file, you should make two copies. Put one of them in a fire-proof safe on-site and the other in a safe location off-site.": "మీరు బ్యాకప్ ఫైల్‌ను డౌన్‌లోడ్ చేసిన తర్వాత, మీరు రెండు కాపీలు చేయాలి వాటిలో ఒకదాన్ని ఫైర్ ప్రూఫ్ సేఫ్ ఆన్-సైట్‌లో మరియు మరొకటి ఆఫ్-సైట్‌లో సురక్షితమైన ప్రదేశంలో ఉంచండి",
    "If you are concerned about confidentiality of data stored in the ChurchCRM database, you should encrypt the backup data if it will be stored somewhere potentially accessible to others": "ChurchCRM డేటాబేస్‌లో నిల్వ చేయబడిన డేటా యొక్క గోప్యత గురించి మీరు ఆందోళన చెందుతుంటే, బ్యాకప్ డేటాను ఇతరులకు అందుబాటులో ఉండే చోట నిల్వ చేయబడితే మీరు దానిని ఎన్‌క్రిప్ట్ చేయాలి",
    "Select archive type": "ఆర్కైవ్ రకాన్ని ఎంచుకోండి",
    "Encrypt backup file with a password?": "పాస్‌వర్డ్‌తో బ్యాకప్ ఫైల్‌ను గుప్తీకరించాలా",
    "Re-type Password": "పాస్వర్డ్ తిరిగి టైప్ చెయ్యండి",
    "Generate and Ship Backup to External Storage": "బాహ్య నిల్వకు బ్యాకప్‌ని రూపొందించండి మరియు రవాణా చేయండి",
    ...
    "Depends whether using person or family output method": "వ్యక్తి లేదా కుటుంబ అవుట్‌పుట్ పద్ధతిని ఉపయోగిస్తున్నారా అనే దానిపై ఆధారపడి ఉంటుంది",
    "Custom Field Selection": "అనుకూల ఫీల్డ్ ఎంపిక",
    "Custom Person Fields": "కస్టమ్ పర్సన్ ఫీల్డ్స్",
    "Custom Family Fields": "అనుకూల కుటుంబ ఫీల్డ్‌లు",
    "Filters": "ఫిల్టర్లు",
    "Records to export": "ఎగుమతి చేయడానికి రికార్డులు",
    "Based on filters below..": "దిగువ ఫిల్టర్‌ల ఆధారంగా..",
    "People in Cart (filters ignored)": "కార్ట్‌లోని వ్యక్తులు (ఫిల్టర్‌లు విస్మరించబడ్డాయి)",
    ...
    "Output Method:": "అవుట్‌పుట్ విధానం:",
    "CSV Individual Records": "CSV వ్యక్తిగత రికార్డులు",
    "CSV Combine Families": "CSV వ్యక్తిగత రికార్డులు",
    "Add Individuals to Cart": "కార్ట్‌కు వ్యక్తులను జోడించండి",
    "Skip records with incomplete mail address": "అసంపూర్ణ మెయిల్ చిరునామాతో రికార్డులను దాటవేయండి",
    "Create File": "ఫైల్‌ని సృష్టించండి",
    "No file selected for upload.": "అప్‌లోడ్ చేయడానికి ఫైల్ ఏదీ ఎంచుకోబడలేదు.",
    "Total number of rows in the CSV file:": "CSV ఫైల్‌లోని మొత్తం అడ్డు వరుసల సంఖ్య:",
    "Ignore this Field": "ఈ ఫీల్డ్‌ను విస్మరించండి",
    "Title": "శీర్షిక",
    "Suffix": "ప్రత్యయం",
    "Gender": "లింగం",
    ...
    "Ignore first CSV row (to exclude a header)": "మొదటి CSV అడ్డు వరుసను విస్మరించండి (హెడర్‌ను మినహాయించడానికి)",
    "Make Family records based on last name and address": "ఇంటిపేరు మరియు చిరునామా ఆధారంగా కుటుంబ రికార్డులను రూపొందించండి",
    "Patriarch": "జాతిపిత",
    "Matriarch": "మాతృక",
    "Family Type: used with Make Family records... option above": "కుటుంబ రకం: మేక్ ఫ్యామిలీ రికార్డ్‌లతో ఉపయోగించబడుతుంది... ఎగువన ఎంపిక",
    "NOTE: Separators (dashes, etc.) or lack thereof do not matter": "గమనిక: సెపరేటర్లు (డాష్‌లు మొదలైనవి) లేదా వాటి లేకపోవడం పట్టింపు లేదు",
    ...
    "ERROR: the uploaded CSV file no longer exists!": "లోపం: అప్‌లోడ్ చేసిన CSV ఫైల్ ఉనికిలో లేదు!",
    ...
    "Add Cart to Event": "ఈవెంట్‌కి కార్ట్‌ని జోడించండి",
    "Select the event to which you would like to add your cart": "మీరు మీ కార్ట్‌ను జోడించాలనుకుంటున్న ఈవెంట్‌ను ఎంచుకోండి",
    "OR": "లేదా",
    "Add New Event": "కొత్త ఈవెంట్‌ని జోడించండి",
    "Your cart is empty!": "మీ కార్ట్ ఖాళీగా ఉంది!",
    "No family name entered!": "ఇంటి పేరు నమోదు చేయలేదు!",
    "Add Cart to Family": "కుటుంబానికి కార్ట్‌ని జోడించండి",
    "Name": "పేరు",
    ...
    "(Use the textbox for countries other than US and Canada)": "(US మరియు కెనడా కాకుండా ఇతర దేశాల కోసం టెక్స్ట్‌బాక్స్‌ని ఉపయోగించండి)",
    "Do not auto-format": "ఆటో-ఫార్మాట్ చేయవద్దు",
    "Add to Family": "కుటుంబానికి జోడించండి",
    "Add Cart to Group": "గుంపుకు కార్ట్‌ని జోడించండి",
    "Select the group to which you would like to add your cart": "మీరు మీ కార్ట్‌ను జోడించాలనుకుంటున్న సమూహాన్ని ఎంచుకోండి",
    "Select Group": "సమూహాన్ని ఎంచుకోండి",
    "No Group Selected": "సమూహం ఎంపిక చేయబడలేదు",
    "Add to Group": "సమూహానికి జోడించండి",
    "View Your Cart": "మీ కార్ట్‌ని వీక్షించండి",
    "You have no items in your cart.": "మీ కార్ట్‌లో ఏ వస్తువులు లేవు.",
    ...
    "Empty Cart to Event": "ఈవెంట్‌కు ఖాళీ కార్ట్",
    ...
    "Select the event to which you would like to check people in for": "మీరు వ్యక్తులను తనిఖీ చేయాలనుకుంటున్న ఈవెంట్‌ను ఎంచుకోండి",
    "Select Event": "ఈవెంట్‌ని ఎంచుకోండి",
    ...
    "Action": "చర్య",
    "No Attendees Assigned to Event": "ఈవెంట్‌కు హాజరైనవారు ఎవరూ కేటాయించబడలేదు",
    "Member": "సభ్యుడు",
    " of the": " యొక్క",
    ...
    "Close deposit slip (remember to press Save)": "డిపాజిట్ స్లిప్‌ను మూసివేయండి (సేవ్ చేయి నొక్కడం గుర్తుంచుకోండి)",
    ...
    "Are you sure you want to delete this fund?": "మీరు ఖచ్చితంగా ఈ ఫండ్‌ని తొలగించాలనుకుంటున్నారా?",
    "Warning: Field changes will be lost if you do not 'Save Changes' before using a delete or 'add new' button!": "హెచ్చరిక: మీరు తొలగింపు లేదా 'కొత్తది జోడించు' బటన్‌ను ఉపయోగించే ముందు 'మార్పులను సేవ్ చేయకపోతే' ఫీల్డ్ మార్పులు కోల్పోతాయి!",
    "Invalid fields or selections. Changes not saved! Please correct and try again!": "చెల్లని ఫీల్డ్‌లు లేదా ఎంపికలు. మార్పులు సేవ్ చేయబడలేదు! దయచేసి సరిచేసి, మళ్లీ ప్రయత్నించండి!",
    ...
    "Event Nonattendees": "ఈవెంట్ నాన్‌టెండిస్",
    ...
    "Guests": "అతిథులు",
    "There are no events in this category": "ఈ వర్గంలో ఈవెంట్‌లు ఏవీ లేవు",
    "Create Event": "ఈవెంట్‌ని సృష్టించండి",
    "Create a new Event": "కొత్త ఈవెంట్‌ని సృష్టించండి",
    ...
    "Return to Events": "ఈవెంట్‌లకు తిరిగి వెళ్ళు",
    ...
    "ATTENDANCE COUNTS": "హాజరు గణనలు",
    "Optional": "ఐచ్ఛికం",
    "Enter a list of the attendance counts you want to include with this event.": "ఈ ఈవెంట్‌తో మీరు చేర్చాలనుకుంటున్న హాజరు గణనల జాబితాను నమోదు చేయండి.",
    ...
    "Warning:  By deleting this field, you will irrevokably lose all family data assigned for this field!": "హెచ్చరిక: ఈ ఫీల్డ్‌ను తొలగించడం ద్వారా, మీరు ఈ ఫీల్డ్ కోసం కేటాయించిన మొత్తం కుటుంబ డేటాను తిరిగి పొందలేని విధంగా కోల్పోతారు!",
    "Warning: Arrow and delete buttons take effect immediately.  Field name changes will be lost if you do not 'Save Changes' before using an up, down, delete or 'add new' button!": "హెచ్చరిక: బాణం మరియు తొలగించు బటన్‌లు వెంటనే ప్రభావం చూపుతాయి. మీరు అప్, డౌన్, డిలీట్ లేదా 'కొత్తది జోడించు' బటన్‌ను ఉపయోగించే ముందు 'మార్పులను సేవ్ చేయకపోతే' ఫీల్డ్ పేరు మార్పులు పోతాయి!",
    "No custom Family fields have been added yet": "అనుకూల కుటుంబ ఫీల్డ్‌లు ఏవీ ఇంకా జోడించబడలేదు",
    ...
    "Add New Field": "కొత్త ఫీల్డ్‌ని జోడించండి",
    ...
    "You may create family members now or add them later.  All entries will become <i>new</i> person records.": "మీరు ఇప్పుడు కుటుంబ సభ్యులను సృష్టించవచ్చు లేదా తర్వాత వారిని జోడించవచ్చు. అన్ని ఎంట్రీలు <i>కొత్త</i> వ్యక్తి రికార్డులుగా మారతాయి.",
    "First": "మొదటి",
    "Middle": "మధ్య",
    "Last": "చివరిది",
    "Role": "పాత్ర",
    ...
    "Add All Family Members to Cart": "కార్ట్‌కి కుటుంబ సభ్యులందరినీ జోడించండి",
    "Timeline": "కాలక్రమం",
    ...
    "You are about to email copy of the family information to the following emails": "మీరు కుటుంబ సమాచారం యొక్క కాపీని క్రింది ఇమెయిల్‌లకు ఇమెయిల్ చేయబోతున్నారు",
    ...
    "Voting members must have made<br> a donation within this many years<br> (0 to not require a donation):": "ఓటింగ్ సభ్యులు తప్పనిసరిగా <br> ఈ అనేక సంవత్సరాలలోపు విరాళం అందించి ఉండాలి<br> (0 విరాళం అవసరం లేదు):",
    "CSV": "CSV",
    "Back": "వెనుకకు",
