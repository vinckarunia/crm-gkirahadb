...
<div class="row">
    ...
    <div class="card col-md-6">
 	...
 	<div class="card col-md-12">
  		<div class="card-body">
    		<h4><?= gettext("LKKJ") ?></h4>
          	<p>Untuk mengedit atau melihat LKKJ lebih lanjut, gunakan tautan <a href="https://metabase.gkirahadb.my.id/" style="text-decoration: none; color: primary;">berikut</a>.</p>
    		<?php
