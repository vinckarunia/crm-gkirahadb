...
if ($sAction === 'Create Event' && !empty($tyid)) {
    ...
    switch ($sDefRecurType) {
        case 'none':
            ...
            $iEventEndMins = intval($aStartTimeTokens[1]) + 30;
            break;
        ...
        case 'weekly':
            ...
            if ($numRows > 0) {
                ...
                $iEventEndMins = $iEventStartMins + 30;
            } else {
                ...
                $sEventEndDate = $sEventStartDate;
                $iEventEndHour = intval($aStartTimeTokens[0]) + 1;
                $iEventEndMins = intval($aStartTimeTokens[1]) + 29;
            }
            break;
        ...
        case 'monthly':
            ...
            if ($numRows > 0) {
                ...
                $iEventEndMins = intval($aEventStartTimeTokens[1]) + 29;
            } else {
                // Use the event type definition
                $currentDOM = date('d');
    ...
    $sEventTitle = $sTypeName . ' ' . $sEventStartDate;
    $sEventDesc = '';
    $sEventText = '';
    $iEventStatus = 0;
    $iTypeID = $type_id;
