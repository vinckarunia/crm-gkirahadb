        ...
        <div class='row form-group'>
          ...
          <div class='col-sm-6'>
            <select class="form-control" name="newEvtStartTime">
              <?php createTimeDropdown(4, 22, 15, '', ''); ?>
            </select>
          </div>
        </div>
        <div class='row form-group'>
          ...
          <div class='col-sm-6'>
            <input class="form-control" type="Text" name="newEvtTypeCntLst" value="<?= $cCountList[$row] ?>" Maxlength="1000" id="nETCL" size="30" placeholder="<?= gettext('Optional') ?>">
